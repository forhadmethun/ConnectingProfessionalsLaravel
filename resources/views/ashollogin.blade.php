...
<header id="masthead" class="masthead navbar navbar-default navbar-fixed-top">
  ...
  <!-- progressbar -->
   <div class="col-md-1">
    ...
    <div class="col-md-10">
  <form role="form" class="form-inline" action="{{ url('/').'/checklogin'}}" method="POST">
    ...
    <div class="row">
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="name" name="name" type="text" placeholder="Enter username" class="form-control input-md" required="">  
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="email" name="email" type="email" placeholder="Enter Email Address" class="form-control input-md" required="">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <button id="" name="button" class="btn btn-info" type="submit">Login</button>
            </div>
          </div>
  </fieldset>
        </form>
